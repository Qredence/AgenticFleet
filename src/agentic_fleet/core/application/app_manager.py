...
from agentic_fleet.config import config_manager  # Use unified config manager
...
class ApplicationManager:
    ...
    def __init__(self, model_client: AzureOpenAIChatCompletionClient):
        ...
        """
        # Use config_manager for all config access
        self.model_configs = config_manager.get_model_settings("azure")
        self.fleet_config = config_manager.get_team_settings("magentic_fleet_one")
